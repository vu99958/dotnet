...
namespace QuanLyNhanSu.Migrations
{
    ...
    [Migration("20260714161733_Add_Tax_Insurance_To_Payslip")]
    partial class Add_Tax_Insurance_To_Payslip
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuanLyNhanSu.AttendanceRecord", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("QuanLyNhanSu.Domain.BiometricTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EnrollNumber", "TemplateType", "FingerIndex")
                        .IsUnique();

                    b.ToTable("AppBiometricTemplates", (string)null);
                });

            modelBuilder.Entity("QuanLyNhanSu.Domain.Branch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QuanLyNhanSu.Domain.Shifts.EmployeeShift", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppEmployeeShifts", (string)null);
                });

            modelBuilder.Entity("QuanLyNhanSu.Domain.Shifts.Shift", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("DeductAmountPerLateMinute")
                    ...
                    b.ToTable("AppShifts", (string)null);
                });

            modelBuilder.Entity("QuanLyNhanSu.Domain.UserKey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QuanLyNhanSu.LeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QuanLyNhanSu.Payslip", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QuanLyNhanSu.SalaryProfile", b =>
                {
                    ...
                    b.ToTable("AppSalaryProfiles", (string)null);
                });
