...
namespace QuanLyNhanSu.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("QuanLyNhanSu") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "QuanLyNhanSu", DisplayName = "QuanLyNhanSu API", Resources = { "QuanLyNhanSu" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["QuanLyNhanSu_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["QuanLyNhanSu_Swagger:RootUrl"]?.TrimEnd('/');
        ...
        // Desktop Client (QuanLyNhanSu_Swagger)
        var desktopClientId = configurationSection["QuanLyNhanSu_Swagger:ClientId"];
        if (!desktopClientId.IsNullOrWhiteSpace())
        {
            await CreateApplicationAsync(
                ...
                type: OpenIddictConstants.ClientTypes.Public,
                consentType: OpenIddictConstants.ConsentTypes.Implicit,
                displayName: "Desktop Client Application",
                secret: null,
                grantTypes: new List<string> 
                { 
                    OpenIddictConstants.GrantTypes.Password,
